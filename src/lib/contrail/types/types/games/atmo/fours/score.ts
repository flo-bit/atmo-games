...
const _guessSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("games.atmo.fours.score#guess")),
		/**
	...
	/*#__PURE__*/ v.object(
		{
			 ...
			 */
			"state": /*#__PURE__*/ v.string<"games.atmo.fours.score#lost" | "games.atmo.fours.score#won" | (string & {})>(),
		}
	)
);
