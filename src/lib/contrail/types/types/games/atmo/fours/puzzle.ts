...
const _groupSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("games.atmo.fours.puzzle#group")),
		/**
		 * The category name that describes what the four words have in common.
		 * @maxLength 400
		 * @maxGraphemes 100
		 */
		"category": /*#__PURE__*/ v.constrain(
			/*#__PURE__*/ v.string(),
			[
		 ...
		 * @maximum 3
		 */
		"difficulty": /*#__PURE__*/ v.constrain(
			/*#__PURE__*/ v.integer(),
