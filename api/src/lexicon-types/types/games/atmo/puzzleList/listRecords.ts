...
import * as GamesAtmoFoursPuzzleList from "../fours/puzzleList.js";
...
const _profileEntrySchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("games.atmo.puzzleList.listRecords#profileEntry")),
...
const _recordSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("games.atmo.puzzleList.listRecords#record")),
		...
		get "value"() {
			return GamesAtmoFoursPuzzleList.mainSchema
		},
	}
);
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		"games.atmo.puzzleList.listRecords": mainSchema;
	}
}
